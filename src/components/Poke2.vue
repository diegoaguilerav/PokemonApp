    ...
    <div class="pokedex-component">
        ...
        <div class="pokedex d-flex justify-content-center">
            <div class="pokedex-container" v-for="(p, index) of store.state.pokemon" :key="index">
                    ...
                    <!--ANIMACION LOADER-->
                    <!-- <div v-if="p.name == undefined" class="lds-ring">
                      <div></div><div></div><div></div><div></div>
                    </div> -->
                    <div>
                        <img class="img-pokemon" v-bind:src="cargar_imagen(p.number)">
...
export default {
  ...
  methods: {
    ...
    cargar_imagen: function(n){
        console.log('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/' + n + '.png')
        return 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/' + n + '.png'
    }
  },
  computed: {
    carga_imagen: function(){
